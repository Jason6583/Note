...
{
    internal class PenViewModel : BindableBase
    {
        ...
        public PenViewModel(InkCanvas inkCanvas)
        {
            SliderCanvas = inkCanvas;
        ...
        private void InitPenType()
        {
            ...
            ballPen.Pen = "圆珠笔";
            ballPen.Image = new BitmapImage(new Uri("ms-appx:///Assets/ballpen3.png", UriKind.Absolute));
            ballPen.CheckedImage = new BitmapImage(new Uri("ms-appx:///Assets/ballpen_hover3.png", UriKind.Absolute));
            ...
            pencil.Pen = "铅笔";
            pencil.Image = new BitmapImage(new Uri("ms-appx:///Assets/pencil3.png", UriKind.Absolute));
            pencil.CheckedImage = new BitmapImage(new Uri("ms-appx:///Assets/pencil_hover3.png", UriKind.Absolute));
            ...
            parkPen.Image = new BitmapImage(new Uri("ms-appx:///Assets/parkpen3.png", UriKind.Absolute));
            parkPen.CheckedImage = new BitmapImage(new Uri("ms-appx:///Assets/parkpen_hover3.png", UriKind.Absolute));
        ...
        private void InitPenSizes()
        {
            ...
            penSize.PenSize = 1.5;
            penSize.CheckedIcon = new BitmapImage(new Uri("ms-appx:///Assets/stroke1_hover3.png", UriKind.Absolute));
            penSize.Icon = new BitmapImage(new Uri("ms-appx:///Assets/stroke1_3.png", UriKind.Absolute));
            this.PenSizes.Add(penSize);
            penSize = new PenTipSize();
            penSize.IconSize = 3;
            penSize.PenSize = 3;
            penSize.CheckedIcon = new BitmapImage(new Uri("ms-appx:///Assets/stroke2_hover3.png", UriKind.Absolute));
            penSize.Icon = new BitmapImage(new Uri("ms-appx:///Assets/stroke2_3.png", UriKind.Absolute));
            this.PenSizes.Add(penSize);
            penSize = new PenTipSize();
            penSize.IconSize = 4.5;
            penSize.PenSize = 4.5;
            penSize.CheckedIcon = new BitmapImage(new Uri("ms-appx:///Assets/stroke3_hover3.png", UriKind.Absolute));
            penSize.Icon = new BitmapImage(new Uri("ms-appx:///Assets/stroke3_3.png", UriKind.Absolute));
            this.PenSizes.Add(penSize);
            penSize = new PenTipSize();
            penSize.IconSize = 9;
            penSize.PenSize = 6;
            penSize.CheckedIcon = new BitmapImage(new Uri("ms-appx:///Assets/stroke4_hover3.png", UriKind.Absolute));
            penSize.Icon = new BitmapImage(new Uri("ms-appx:///Assets/stroke4_3.png", UriKind.Absolute));
            this.PenSizes.Add(penSize);
            penSize = new PenTipSize();
            penSize.IconSize = 12;
            penSize.PenSize = 12;
            penSize.CheckedIcon = new BitmapImage(new Uri("ms-appx:///Assets/stroke5_hover3.png", UriKind.Absolute));
            penSize.Icon = new BitmapImage(new Uri("ms-appx:///Assets/stroke5_3.png", UriKind.Absolute));
            this.PenSizes.Add(penSize);
        ...
        public void UpdateCanvas()
        {
            try
            {
                ...
                Points.Add(new Point(72, 10));
                Points.Add(new Point(122, 20));
                Points.Add(new Point(172, 30));
                Points.Add(new Point(222, 10));
