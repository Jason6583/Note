...
{
    public class InkStrokeAudioService : BindableBase
    {
        ...
        public string AudioLength
        {
            ...
            set
            {
                this.SetProperty(ref audioLength, value);
                this._inkCanvasEx.AudioLength = this.audioLength;
            }
        }
            ...
            get
            {
                return this.exportCommand ?? (this.exportCommand = new RelayCommand(async () =>
                {
                    ...
                    if (File.Exists(AudioPath))
                    {
                        ...
                        this._inkCanvasEx.ToastNotify("导出成功");
                    }
                    else
                    {
                        this._inkCanvasEx.ToastNotify("导出失败");
                    }
                }));
            }
        }
        ...
        public ICommand DeleteCommand
        {
            get => this.deleteCommand ?? (this.deleteCommand = new RelayCommand(() =>
            {
                ...
                if (File.Exists(AudioPath))
                {
                    ...
                    this._inkCanvasEx.ToastNotify("删除成功");
                }
            }));
        }
        #endregion
        ...
        public List<RecordInfo> RecordInfos
        {
            ...
            set
            {
                this.SetProperty(ref this.recordInfos, value);
                var audioPath = this.AudioPath;
                var recordInfo = JsonConvert.SerializeObject(this.recordInfos);
                this._eventBus.Publish(new AudioChangedEventArgs()
                {
                    AudioPath = audioPath,
                    AudioData = recordInfo
                });
            }
        }
        ...
        //初始化音频设备
        public InkStrokeAudioService()
        {

        }
        public void InitAudioService(InkCanvasViewModel inkCanvasEx)
        {
            ...
            coreInkIndependentInputSource = CoreInkIndependentInputSource.Create(_inkCanvas.InkPresenter);
